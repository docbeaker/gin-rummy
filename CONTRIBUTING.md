...
Welcome to `gin-rummy` contributor's guide.
...
If you experience bugs or general issues with `gin-rummy`, please have a look
...
You can help improve `gin-rummy` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`gin-rummy` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `gin-rummy`'s files. While this mechanism can
...
```
conda create -n gin-rummy python=3 six virtualenv pytest pytest-cov
conda activate gin-rummy
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/gin-rummy.git
   cd gin-rummy
   ```
...
5. Install [pre-commit]:
   ...
   `gin-rummy` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/gin-rummy
[issue tracker]: https://github.com/<USERNAME>/gin-rummy/issues
